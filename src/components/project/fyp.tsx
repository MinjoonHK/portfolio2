          ...
          <div className="ProjectContentInnerWraper">
            ...
            <div className="ProjectSummaryWrapper">
              ...
              <div className="ProjectSummaryContent">
                ...
                <p>
                  개발자로서의 진로를 정한후 졸업전 의미있는 프로젝트를
                  진행해보고 싶어 컴퓨터 공학과의 팀 프로젝트에 참여하였습니다.
                  <p>
                    개발 당시 <b>Chat-GPT</b> 가 출시되어 화재를 모으고 있었고
                    이를 졸업 프로젝트에 응용 해보고자 <b>Chat GPT</b>의
                    <b>Prompt Engineering</b> 을 활용하여 유저와 상호작용 하도록
                    만들었습니다.
                  </p>
                  또한 기획 당시 타겟층을 몸이 불편한 환자들로 설정하였기 때문에
                  편의성을 높이고자 Pyttsx 와 Google text to speech 를 활용하여
                  대화를 통해 로봇팔에게 명령할수 있도록 하였습니다.
                </p>
                <p>
                  3명의 다른 팀원들과 함께 노력한 끝에 2023년 공과대학 최우수
                  프로젝트에 선정되었습니다. 또한 2023년 학교를 대표하는 최우수
                  졸업 프로젝트 16개중 하나로 선정되었습니다.
                </p>
              </div>
